...
export class TripService {
  ...
  async create(createTripDto: CreateTripDto) {
    return this.prisma.trip.create({
      data: {
        ...
        arrivalTime: createTripDto.arrivalTime ? new Date(createTripDto.arrivalTime) : null,
      },
      include: {
        route: true,
        bus: true,
  ...
  async update(id: string, updateTripDto: UpdateTripDto) {
    ...
    if (updateTripDto.departureTime) {
      data.departureTime = new Date(updateTripDto.departureTime);
    }
    if (updateTripDto.arrivalTime) {
      data.arrivalTime = new Date(updateTripDto.arrivalTime);
    }
